...
| `GET /api/eod/conviction/calibration?days=N` | **Does stacking pay?** — scores the saved conviction ideas' realized TARGET/STOP outcomes: win rate by pillar count, per-pillar lift, option-⚠️ impact + verdict |
...
├── test_*.py               # 698 unit tests, 33 suites (client/quote/paper/strategies/sim/backtests/walkforward/portfolio/bhavcopy/deals/eodscanner/eodconviction/eodoptions/eodscheduler/sectors/sectorscan/convictioncalibration/db/app+routes/feeds/…)
├── templates/
